...
function enviarlatlon()
{
  //enviar latitud y longitud
  latitud = document.getElementById('minDate').value;
  longitud = document.getElementById('minIntensity').value;

  $.ajax({
    url: 'http://72.14.183.67/ws/qr/qr.php',
    success: function (result){
    
    //acceder al servicio para devolver una imagen qr.
